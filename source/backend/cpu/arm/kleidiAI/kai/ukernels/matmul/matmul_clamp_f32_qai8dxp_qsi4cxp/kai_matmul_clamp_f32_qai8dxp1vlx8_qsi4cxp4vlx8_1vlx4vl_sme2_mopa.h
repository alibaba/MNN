...
/// -# kai_rhs_pack_nxk_qsi4cxps1s0_qsu4cxs1s0 to pack the RHS matrix
...
///
/// @return the destination(DST) offset in bytes
...
///
/// LHS matrix: Signed 8-bit quantized asymmetric per-row (qai8dxp) and packed
/// RHS matrix: Signed 4-bit quantized symmetric per-channel (qsi4cxp) and packed.
///
...
/// kai_run_rhs_pack_nxk_qsi4cxps1s0_qsu4cxs1s0
