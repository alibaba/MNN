...
namespace MNN {
    ...
    static void packNCHWToNC4HW4(float* data, size_t rowNum, size_t rowSize);
    static void packNCHWToNC4HW4(__fp16* data, size_t rowNum, size_t rowSize);
    static void packNC4HW4ToNCHW(float* data, size_t rowNum, size_t rowSize);
    static void packNC4HW4ToNCHW(__fp16* data, size_t rowNum, size_t rowSize);
    ...
    static void packQsi4cxpoQsu4cxs0s1(
        size_t num_groups,   //
        size_t n,            //
        size_t k,            //
        size_t nr,           //
