...
void MNNC3ToHSV(const unsigned char* source, unsigned char* dest, size_t count, bool bgr, bool full) {
    ...
    while (i < count) {
        ...
        vuint8m2_t vmaxU8 = __riscv_vmaxu_vv_u8m2(__riscv_vmaxu_vv_u8m2(vrU8, vgU8, vl), vbU8, vl);
        vuint8m2_t vminU8 = __riscv_vminu_vv_u8m2(__riscv_vminu_vv_u8m2(vrU8, vgU8, vl), vbU8, vl);
        ...
        vint16m4_t sum16 =
            __riscv_vadd_vv_i16m4(__riscv_vsub_vv_i16m4(vr, vg, vl), __riscv_vsll_vx_i16m4(vdiff, 2, vl), vl);
        vint16m4_t temp16 =
            __riscv_vadd_vv_i16m4(__riscv_vsub_vv_i16m4(vb, vr, vl), __riscv_vsll_vx_i16m4(vdiff, 1, vl), vl);
        ...
        sumF = __riscv_vfdiv_vv_f32m8(__riscv_vfmul_vf_f32m8(diffF, 255.0f, vl), __riscv_vfmax_vf_f32m8(sumF, 1.0f, vl),
                                      vl);
