    ...
    while (i < number) {
        ...
        for (int c = 0; c < pack; c++) {
            vuint32m8_t voff = __riscv_vsll_vx_u32m8(
                __riscv_vreinterpret_v_i32m8_u32m8(__riscv_vlse32_v_i32m8(position + 2 * i, 8, vl)), 4, vl);
            ...
            voff = __riscv_vsll_vx_u32m8(
                __riscv_vreinterpret_v_i32m8_u32m8(__riscv_vlse32_v_i32m8(position + 2 * i + 1, 8, vl)), 4, vl);
            voff = __riscv_vadd_vx_u32m8(voff, c * 4, vl);
