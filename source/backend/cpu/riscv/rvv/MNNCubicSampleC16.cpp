    ...
    while (i < number) {
        ...
        for (int c = 0; c < pack; c++) {
            vuint32m8_t voff = __riscv_vsll_vx_u32m8(
                __riscv_vreinterpret_v_i32m8_u32m8(__riscv_vlse32_v_i32m8(position + 4 * i + 0, 16, vl)), 4, vl);
            ...
            vfloat32m8_t vtmp = __riscv_vfcvt_f_x_v_f32m8(__riscv_vwcvt_x_x_v_i32m8(vtmp_i16, vl), vl);
            ...
            voff = __riscv_vsll_vx_u32m8(
                __riscv_vreinterpret_v_i32m8_u32m8(__riscv_vlse32_v_i32m8(position + 4 * i + 1, 16, vl)), 4, vl);
            voff = __riscv_vadd_vx_u32m8(voff, c, vl);

            vtmp_i8 = __riscv_vluxei32_v_i8m2(src, voff, vl);
            vtmp_i16 = __riscv_vwsub_vx_i16m4(vtmp_i8, zp, vl);
            vfloat32m8_t vB = __riscv_vfcvt_f_x_v_f32m8(__riscv_vwcvt_x_x_v_i32m8(vtmp_i16, vl), vl);

            va = __riscv_vfmacc_vf_f32m8(va, 1.25f, vB, vl);
            vb = __riscv_vfmacc_vf_f32m8(vb, -2.25f, vB, vl);

            voff = __riscv_vsll_vx_u32m8(
                __riscv_vreinterpret_v_i32m8_u32m8(__riscv_vlse32_v_i32m8(position + 4 * i + 2, 16, vl)), 4, vl);
            voff = __riscv_vadd_vx_u32m8(voff, c, vl);

            vtmp_i8 = __riscv_vluxei32_v_i8m2(src, voff, vl);
            vtmp_i16 = __riscv_vwsub_vx_i16m4(vtmp_i8, zp, vl);
            vtmp = __riscv_vfcvt_f_x_v_f32m8(__riscv_vwcvt_x_x_v_i32m8(vtmp_i16, vl), vl);
            ...
            voff = __riscv_vsll_vx_u32m8(
                __riscv_vreinterpret_v_i32m8_u32m8(__riscv_vlse32_v_i32m8(position + 4 * i + 3, 16, vl)), 4, vl);
            voff = __riscv_vadd_vx_u32m8(voff, c, vl);
