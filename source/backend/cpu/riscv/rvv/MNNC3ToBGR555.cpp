...
void MNNC3ToBGR555(const unsigned char* source, unsigned char* dest, 
    ...
    while (i < count) {
        ...
        vuint8m4_t masked = __riscv_vand_vx_u8m4(channel, 0xF8, vl);
        vuint16m8_t wide = __riscv_vzext_vf2_u16m8(masked, vl);
        wide = __riscv_vsll_vx_u16m8(wide, 2, vl);
        ...
        wide = __riscv_vsll_vx_u16m8(wide, 7, vl);
        result = __riscv_vor_vv_u16m8(result, wide, vl);
