...
#else
    auto m0 = vtrn1q_s32((int32x4_t) vec0.value, (int32x4_t) vec1.value), m1 = vtrn2q_s32((int32x4_t) vec0.value, (int32x4_t) vec1.value);
    auto m2 = vtrn1q_s32((int32x4_t) vec2.value, (int32x4_t) vec3.value), m3 = vtrn2q_s32((int32x4_t) vec2.value, (int32x4_t) vec3.value);
    vec0.value = (int8x16_t) vtrn1q_s64((int64x2_t) m0, (int64x2_t) m2);
    vec1.value = (int8x16_t) vtrn1q_s64((int64x2_t) m1, (int64x2_t) m3);
    vec2.value = (int8x16_t) vtrn2q_s64((int64x2_t) m0, (int64x2_t) m2);
    vec3.value = (int8x16_t) vtrn2q_s64((int64x2_t) m1, (int64x2_t) m3);
#endif
}
#endif
