...
public:
    enum class KernelType { FP16 = 0, FP32, KERNEL_TYPE_ERROR };

    // Whether the running CPU can accelerate a float convolution of this precision.
    static bool isSupported(bool bFP16);

    KleidiAIConvolution(const Convolution2DCommon* common, Backend* b, const float* originWeight,
                        size_t originWeightSize, const float* bias, size_t biasSize);
    KleidiAIConvolution(std::shared_ptr<CPUConvolution::Resource> resource, const Convolution2DCommon* common,
                        Backend* b);
...
private:
    ...
    struct Ukernel {
        ...
        void (*runRhsPack)(size_t numGroups, size_t n, size_t k, size_t nr, size_t kr, size_t sr, size_t rhsStride,
                           const void* rhs, const void* bias, const void* scale, void* rhsPacked, size_t extraBytes,
                           const void* params) = nullptr;
        size_t (*lhsPackedSize)(size_t m, size_t k, size_t mr, size_t kr, size_t sr) = nullptr;
        void (*runLhsPack)(size_t m, size_t k, size_t mr, size_t kr, size_t sr, size_t mIdxStart, const void* lhs,
                           size_t lhsStride, void* lhsPacked) = nullptr;
        void (*matmulGemm)(size_t m, size_t n, size_t k, const void* lhsPacked, const void* rhsPacked, void* dst,
                           size_t dstStrideRow, size_t dstStrideCol, float clampMin, float clampMax) = nullptr;
        void (*matmulGemv)(size_t m, size_t n, size_t k, const void* lhsPacked, size_t lhsStride, const void* rhsPacked,
                           void* dst, size_t dstStrideRow, size_t dstStrideCol, float clampMin,
                           float clampMax) = nullptr;
    };
    ...
    void runRhsPack(size_t numGroups, size_t n, size_t k, size_t rhsStride, const void* rhs, const void* scale,
                    const void* bias, void* rhsPacked) const;
    ...
    void runMatmul(size_t m, size_t n, size_t k, const void* lhsPacked, const void* rhsPacked, void* dst,
