...
void CutlassGemmTuneCommonExecution::setGemmBatchedTensorCoreFloat16Argments(const GemmParamInfo* params) {
    ...
    // MNN_PRINT("gemmbatched: batch-%d, problem-%d %d %d, layout:%d vec:%d\n", params->batchSize, params->problemSize[0], params->problemSize[1], params->problemSize[2], params->layout, params->epilogueVectorize);
