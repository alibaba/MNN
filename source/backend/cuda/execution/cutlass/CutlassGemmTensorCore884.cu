#ifndef CutlassGemmCudaTensorCore884_cuh
#define CutlassGemmCudaTensorCore884_cuh

#include "../ConvCutlassExecution.hpp"

namespace MNN {
namespace CUDA {
ErrorCode ConvCutlassExecution::callCutlassGemmTensorCore884(const std::vector<Tensor*> &inputs, const std::vector<Tensor*> &outputs) {
    auto input = inputs[0];
...
#endif //CutlassGemmCudaTensorCore884_cuh