...
public:
    ...
    AttentionExecution(Backend* backend, bool kv_cache_op_param, int op_head_dim); // kv_cache_op_param 来自 Op 定义
...
private:
    ...
    bool mQueryC4HasTail = false;
    bool mKeyC4HasTail = false;
    ...
    std::shared_ptr<Tensor> mC4QueryContiguous;
    std::shared_ptr<Tensor> mC4KeyContiguous;
