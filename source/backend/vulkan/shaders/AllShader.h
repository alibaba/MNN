...
extern const unsigned char glsl_matmul_kernel_comp[];
extern unsigned int glsl_matmul_kernel_comp_len;
extern const unsigned char glsl_matmul_kernel_TRANSPOSE_comp[];
extern unsigned int glsl_matmul_kernel_TRANSPOSE_comp_len;
