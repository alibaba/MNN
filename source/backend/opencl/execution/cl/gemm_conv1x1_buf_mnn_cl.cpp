...
"#define UCHAR4_TO_CHAR8(a, c) "" a.s0=(c.s0 >> 4); a.s1=(c.s0 & 15); a.s2=(c.s1 >> 4); a.s3=(c.s1 & 15); a.s4=(c.s2 >> 4); a.s5=(c.s2 & 15); a.s6=(c.s3 >> 4); a.s7=(c.s3 & 15);\n"
...
"#define UCHAR2_TO_CHAR8_W2(a, b0, b1) "" a.s0 = (char)((b0 >> 6) & 3); "" a.s1 = (char)((b0 >> 4) & 3); "" a.s2 = (char)((b0 >> 2) & 3); "" a.s3 = (char)((b0 >> 0) & 3); "" a.s4 = (char)((b1 >> 6) & 3); "" a.s5 = (char)((b1 >> 4) & 3); "" a.s6 = (char)((b1 >> 2) & 3); "" a.s7=(char)((b1 >> 0) & 3);\n"
"// 3bit unpack: 2 low bytes+1 high byte → 8 chars,unsigned [0,7].\n"
"// Origin offset is folded into the dequant `offset` (or asym bias) by the caller.\n"
"#define UCHAR3_TO_CHAR8_W3(a, b0, b1, h) "" a.s0 = (char)(((b0 >> 6) & 3) | (((h >> 7) & 1) << 2)); "" a.s1 = (char)(((b0 >> 4) & 3) | (((h >> 6) & 1) << 2)); "" a.s2 = (char)(((b0 >> 2) & 3) | (((h >> 5) & 1) << 2)); "" a.s3 = (char)(((b0 >> 0) & 3) | (((h >> 4) & 1) << 2)); "" a.s4 = (char)(((b1 >> 6) & 3) | (((h >> 3) & 1) << 2)); "" a.s5 = (char)(((b1 >> 4) & 3) | (((h >> 2) & 1) << 2)); "" a.s6 = (char)(((b1 >> 2) & 3) | (((h >> 1) & 1) << 2)); "" a.s7=(char)(((b1 >> 0) & 3) | (((h >> 0) & 1) << 2));\n"
...
"}\n"
"#define UCHAR4_TO_FLOAT8(b, scale, offset) "" wei.s0 = CONVERT_FLOAT((b.s0 >> 4)); "" wei.s1 = CONVERT_FLOAT((b.s0 & 15)); "" wei.s2 = CONVERT_FLOAT((b.s1 >> 4)); "" wei.s3 = CONVERT_FLOAT((b.s1 & 15)); "" wei.s4 = CONVERT_FLOAT((b.s2 >> 4)); "" wei.s5 = CONVERT_FLOAT((b.s2 & 15)); "" wei.s6 = CONVERT_FLOAT((b.s3 >> 4)); "" wei.s7 = CONVERT_FLOAT((b.s3 & 15)); "" wei=wei*scale+offset;\n"
