...
const char* gemm_conv1x1_buf =
    ...
    " #else\n"
    " scale.s01234567=CONVERT_COMPUTE_FLOAT8(convert_float8(vload8(0,dequantScaleOffset+(out_c_idx << "
    "2)+i*dstChannelAlign))/coef);\n"
    ...
    " COMPUTE_FLOAT16 "
    "wei1=CONVERT_COMPUTE_FLOAT16(as_char16(read_imagei(weight,SAMPLER,(int2)(k2+1,y))))*scale+offset;\n"
    " #else\n"
