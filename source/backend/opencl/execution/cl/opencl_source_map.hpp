...
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
extern const char* gated_rms_norm_buf;
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
...
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
extern const char* shared_gather_buf;
#endif
...
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
extern const char* fused_proj_gemv_buf;
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
...
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
    {"gated_rms_norm_buf", gated_rms_norm_buf},
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
    {"unary_buf", unary_buf},
#endif
...
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
    {"shared_gather_buf", shared_gather_buf},
#endif
    {"pooling", pooling},
#ifndef MNN_OPENCL_BUFFER_CLOSED
...
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
    {"fused_proj_gemv_buf", fused_proj_gemv_buf},
#endif
#ifndef MNN_OPENCL_BUFFER_CLOSED
...
const std::map<std::string, std::string> OpenCLProgramMd5Map = {
    ...
    {"unary", "74343ac0107d0bdcbd26aaea1c8d13ac"},
    ...
    {"linear_attention_buf", "3fdd363d874924c3a671cf1d41588ac9"},
    {"matmul_local_buf", "2497e20b734f5b77d021524648437b75"},
    {"conv_2d_int_buf", "98f69a5137906f806d8a406d4797a761"},
    ...
    {"binary_buf", "4ec08b49515179a483a7afb4edf736d8"},
    ...
    {"rope_buf", "fefcb085cd16e8d5880687e30867d8e6"},
    ...
    {"gated_rms_norm_buf", "1886377f059c2e18d14919eaa84f6b0b"},
    ...
    {"matmul_buf", "c16b97f576a6b7d804fed52e0bdc7ad8"},
    {"shared_gather_buf", "1e1bd38a7a5d88d890c195866ba4beb3"},
    ...
    {"layernorm_buf", "a496b8b1b2c74fcb6286ad5be7a13503"},
    ...
    {"fused_proj_gemv_buf", "949aa438556236d9271ae1dd58d48bc4"},
