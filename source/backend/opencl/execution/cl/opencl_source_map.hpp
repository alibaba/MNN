...
const std::map<std::string, std::string> OpenCLProgramMd5Map = 
 { 
  { "conv_2d", "603bad4f34d1d390ce82e0444e50d2a2" },
  ...
  { "gemv_conv1x1_buf", "48afa760997cd9dfe22a116d7bb4b394" },
  ...
  { "glmem_convert", "e94c0ad70e7174b8362b254dc9366563" },
  ...
  { "gemm_buf", "febcd1d1ec7d7247fb8ea0e39848c4f2" },
  ...
  { "conv_2d_buf", "c09e5f9605a73e31a069d8250ed55e95" },
