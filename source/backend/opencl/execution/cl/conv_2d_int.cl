...
void conv_2d_1x1(GLOBAL_SIZE_2_DIMS __read_only image2d_t input,
    ...
    for (int in_channel_block_idx = 0; in_channel_block_idx < in_channel_block; ++in_channel_block_idx) {
        ...
        charWeights0.x = (charWeightsInt4.s0 >> 4);
        charWeights0.y = (charWeightsInt4.s0 & MOD_NUM);
        charWeights0.z = (charWeightsInt4.s1 >> 4);
        charWeights0.w = (charWeightsInt4.s1 & MOD_NUM);
        charWeights1.x = (charWeightsInt4.s2 >> 4);
        charWeights1.y = (charWeightsInt4.s2 & MOD_NUM);
        charWeights1.z = (charWeightsInt4.s3 >> 4);
        charWeights1.w = (charWeightsInt4.s3 & MOD_NUM);
        charWeights2.x = (charWeightsInt4.s4 >> 4);
        charWeights2.y = (charWeightsInt4.s4 & MOD_NUM);
        charWeights2.z = (charWeightsInt4.s5 >> 4);
        charWeights2.w = (charWeightsInt4.s5 & MOD_NUM);
        charWeights3.x = (charWeightsInt4.s6 >> 4);
        charWeights3.y = (charWeightsInt4.s6 & MOD_NUM);
        charWeights3.z = (charWeightsInt4.s7 >> 4);
        charWeights3.w = (charWeightsInt4.s7 & MOD_NUM);
...
void conv_2d_1x1_c8h1w4(GLOBAL_SIZE_2_DIMS __read_only image2d_t input,
    ...
    for (int in_channel_block_idx = 0; in_channel_block_idx < in_channel_block; ++in_channel_block_idx) {
        ...
        charWeights3.z = (charWeightsInt4.s7 >> 4);
        charWeights3.w = (charWeightsInt4.s7 & MOD_NUM);
        charWeights4.x = (charWeightsInt4.s8 >> 4);
        charWeights4.y = (charWeightsInt4.s8 & MOD_NUM);
        charWeights4.z = (charWeightsInt4.s9 >> 4);
        charWeights4.w = (charWeightsInt4.s9 & MOD_NUM);
        charWeights5.x = (charWeightsInt4.sa >> 4);
        charWeights5.y = (charWeightsInt4.sa & MOD_NUM);
        charWeights5.z = (charWeightsInt4.sb >> 4);
        charWeights5.w = (charWeightsInt4.sb & MOD_NUM);
        charWeights6.x = (charWeightsInt4.sc >> 4);
        charWeights6.y = (charWeightsInt4.sc & MOD_NUM);
        charWeights6.z = (charWeightsInt4.sd >> 4);
        charWeights6.w = (charWeightsInt4.sd & MOD_NUM);
        charWeights7.x = (charWeightsInt4.se >> 4);
        charWeights7.y = (charWeightsInt4.se & MOD_NUM);
        charWeights7.z = (charWeightsInt4.sf >> 4);
        charWeights7.w = (charWeightsInt4.sf & MOD_NUM);
        weights0 = mad(CONVERT_FLOAT4(charWeights0), scale0, offset0);
        weights1 = mad(CONVERT_FLOAT4(charWeights1), scale0, offset0);
        weights2 = mad(CONVERT_FLOAT4(charWeights2), scale0, offset0);
        weights3 = mad(CONVERT_FLOAT4(charWeights3), scale0, offset0);
