...
"#define UCHAR4_TO_CHAR8(b, scale, offset) "" wei.s0 = CONVERT_FLOAT((b.s0 >> 4)); "" wei.s1 = CONVERT_FLOAT((b.s0 & 15)); "" wei.s2 = CONVERT_FLOAT((b.s1 >> 4)); "" wei.s3 = CONVERT_FLOAT((b.s1 & 15)); "" wei.s4 = CONVERT_FLOAT((b.s2 >> 4)); "" wei.s5 = CONVERT_FLOAT((b.s2 & 15)); "" wei.s6 = CONVERT_FLOAT((b.s3 >> 4)); "" wei.s7 = CONVERT_FLOAT((b.s3 & 15)); "" wei=wei*scale+offset;\n"
...
"#define UCHAR2_TO_CHAR8_W2(b0, b1, scale, offset) "" wei.s0 = CONVERT_FLOAT(((int)((b0 >> 6) & 3))); "" wei.s1 = CONVERT_FLOAT(((int)((b0 >> 4) & 3))); "" wei.s2 = CONVERT_FLOAT(((int)((b0 >> 2) & 3))); "" wei.s3 = CONVERT_FLOAT(((int)((b0 >> 0) & 3))); "" wei.s4 = CONVERT_FLOAT(((int)((b1 >> 6) & 3))); "" wei.s5 = CONVERT_FLOAT(((int)((b1 >> 4) & 3))); "" wei.s6 = CONVERT_FLOAT(((int)((b1 >> 2) & 3))); "" wei.s7 = CONVERT_FLOAT(((int)((b1 >> 0) & 3))); "" wei=wei*scale+offset;\n"
...
"#define UCHAR3_TO_CHAR8_W3(b0, b1, h, scale, offset) "" wei.s0 = CONVERT_FLOAT(((int)(((b0 >> 6) & 3) | (((h >> 7) & 1) << 2)))); "" wei.s1 = CONVERT_FLOAT(((int)(((b0 >> 4) & 3) | (((h >> 6) & 1) << 2)))); "" wei.s2 = CONVERT_FLOAT(((int)(((b0 >> 2) & 3) | (((h >> 5) & 1) << 2)))); "" wei.s3 = CONVERT_FLOAT(((int)(((b0 >> 0) & 3) | (((h >> 4) & 1) << 2)))); "" wei.s4 = CONVERT_FLOAT(((int)(((b1 >> 6) & 3) | (((h >> 3) & 1) << 2)))); "" wei.s5 = CONVERT_FLOAT(((int)(((b1 >> 4) & 3) | (((h >> 2) & 1) << 2)))); "" wei.s6 = CONVERT_FLOAT(((int)(((b1 >> 2) & 3) | (((h >> 1) & 1) << 2)))); "" wei.s7 = CONVERT_FLOAT(((int)(((b1 >> 0) & 3) | (((h >> 0) & 1) << 2)))); "" wei=wei*scale+offset;\n"
"#if WGS >= 8\n"
