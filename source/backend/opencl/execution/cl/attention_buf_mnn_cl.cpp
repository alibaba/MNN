...
const char* attention_buf =
    ...
    "\n"
    " vstore4((FLOAT4)(query_vec0.s2,query_vec1.s2,query_vec2.s2,query_vec3.s2),0,query_tmp+queryout_offset+seq_len4+"
    "seq_len4);\n"
    " vstore4((FLOAT4)(query_vec0.s3,query_vec1.s3,query_vec2.s3,query_vec3.s3),0,query_tmp+queryout_offset+seq_len4+"
    "seq_len4+seq_len4);\n"
    "}\n"
    ...
    " vstore4((FLOAT4)(key_vec0.s3,key_vec1.s3,key_vec2.s3,key_vec3.s3),0,past_key+output_offset+max_len+max_len+max_"
    "len);\n"
    "#else\n"
    ...
    " mask_tmp0=convert_float4(vload4(0,mask+mask_offset)); mask_offset += mask_key_seq_len;\n"
    " mask_tmp1=(x4+1 >= query_seq_len) ? (float4)0 : convert_float4(vload4(0,mask+mask_offset)); mask_offset += "
    "mask_key_seq_len;\n"
    " mask_tmp2=(x4+2 >= query_seq_len) ? (float4)0 : convert_float4(vload4(0,mask+mask_offset)); mask_offset += "
    "mask_key_seq_len;\n"
    ...
    " mask_tmp1=(x4+1 >= query_seq_len) ? (float4)0 : (float4)(mask[mask_offset],0,0,0); mask_offset += "
    "mask_key_seq_len;\n"
    " mask_tmp2=(x4+2 >= query_seq_len) ? (float4)0 : (float4)(mask[mask_offset],0,0,0); mask_offset += "
    "mask_key_seq_len;\n"
    ...
    " mask_tmp1=(x4+1 >= query_seq_len) ? (float4)0 : (float4)(mask[mask_offset],mask[mask_offset+1],0,0); mask_offset "
    "+= mask_key_seq_len;\n"
    " mask_tmp2=(x4+2 >= query_seq_len) ? (float4)0 : (float4)(mask[mask_offset],mask[mask_offset+1],0,0); mask_offset "
    "+= mask_key_seq_len;\n"
    " mask_tmp3=(x4+3 >= query_seq_len) ? (float4)0 : (float4)(mask[mask_offset],mask[mask_offset+1],0,0);\n"
    " }else if(y4+3 == mask_key_seq_len){\n"
    " mask_tmp0=(float4)(mask[mask_offset],mask[mask_offset+1],mask[mask_offset+2],0); mask_offset += "
    "mask_key_seq_len;\n"
    " mask_tmp1=(x4+1 >= query_seq_len) ? (float4)0 : "
    "(float4)(mask[mask_offset],mask[mask_offset+1],mask[mask_offset+2],0); mask_offset += mask_key_seq_len;\n"
    " mask_tmp2=(x4+2 >= query_seq_len) ? (float4)0 : "
    "(float4)(mask[mask_offset],mask[mask_offset+1],mask[mask_offset+2],0); mask_offset += mask_key_seq_len;\n"
    " mask_tmp3=(x4+3 >= query_seq_len) ? (float4)0 : "
    "(float4)(mask[mask_offset],mask[mask_offset+1],mask[mask_offset+2],0);\n"
    " }\n"
    " }\n"
    ...
    " float4 mask0=mask_clp >= 0 && mask_clp<mask_key_seq_len ? convert_float4(vload4(0,mask+mask_offset)) : 0; "
    "mask_offset += query_seq_len4;\n"
    " float4 mask1=mask_clp+1 >= 0 && mask_clp+1<mask_key_seq_len? convert_float4(vload4(0,mask+mask_offset)) : 0; "
    "mask_offset += query_seq_len4;\n"
    " float4 mask2=mask_clp+2 >= 0 && mask_clp+2<mask_key_seq_len? convert_float4(vload4(0,mask+mask_offset)) : 0; "
    "mask_offset += query_seq_len4;\n"
