...
__kernel void gemm_conv(GLOBAL_SIZE_DIM2
    ...
    for (int k = 0; k < srcChannelC4; ++k) {
        ...
        charWeights.s0 = (charWeightsInt4.s0 >> 4);
        charWeights.s1 = (charWeightsInt4.s0 & 15);
        charWeights.s2 = (charWeightsInt4.s1 >> 4);
        charWeights.s3 = (charWeightsInt4.s1 & 15);
        charWeights.s4 = (charWeightsInt4.s2 >> 4);
        charWeights.s5 = (charWeightsInt4.s2 & 15);
        charWeights.s6 = (charWeightsInt4.s3 >> 4);
        charWeights.s7 = (charWeightsInt4.s3 & 15);
        charWeights.s8 = (charWeightsInt4.s4 >> 4);
        charWeights.s9 = (charWeightsInt4.s4 & 15);
        charWeights.sa = (charWeightsInt4.s5 >> 4);
        charWeights.sb = (charWeightsInt4.s5 & 15);
        charWeights.sc = (charWeightsInt4.s6 >> 4);
        charWeights.sd = (charWeightsInt4.s6 & 15);
        charWeights.se = (charWeightsInt4.s7 >> 4);
        charWeights.sf = (charWeightsInt4.s7 & 15);
