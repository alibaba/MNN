...
const char* layernorm_buf =
    ...
    "#endif\n"
    "#define MASK_C4_TAIL(value,index,channel_unit,remain) do { if ((remain)!=0 && (index)==(channel_unit)-1) { if ((remain)<4) (value).w=0.0f; if ((remain)<3) (value).z=0.0f; if ((remain)<2) (value).y=0.0f; } } while (0)\n"
