...
// convert data from buffer(nhwc) to buffer(nc4hw4) float input
__kernel void nhwc_buffer_to_nc4hw4_buffer_floatin(GLOBAL_SIZE_2_DIMS
                                   __global const float *input_ptr,
                                   __private const int height,
                                   __private const int width, __private const int channels,
                                   __global FLOAT *output) {
...
// convert data from buffer(nchw) to buffer(nc4hw4)
__kernel void nchw_buffer_to_nc4hw4_buffer_floatin(GLOBAL_SIZE_2_DIMS
                                   __global const float *input_ptr,
                                   __private const int height, __private const int width, __private const int channels,
                                   __global FLOAT *output) {
    int image_width_idx  = get_global_id(0);
...
// convert data from image(b h, ic/4 w ic4) to buffer(nhwc)
__kernel void nc4hw4_buffer_to_nhwc_buffer_floatout(GLOBAL_SIZE_2_DIMS
                                    __global float *output,
                                    __private const int height, __private const int width,
                                    __private const int channels,
                                    __global FLOAT *input_ptr) {
...
// convert data from buffer(nc4hw4) to buffer(nchw)
__kernel void nc4hw4_buffer_to_nchw_buffer_floatout(GLOBAL_SIZE_2_DIMS
                                    __global float *output,
                                    __private const int height, __private const int width,
                                    __private const int channels,
                                    __global FLOAT *input_ptr) {
...
__kernel void nc4hw4_buffer_to_nc4hw4_buffer_floatin(GLOBAL_SIZE_2_DIMS
                                    __global const float *input_ptr,
                                    __private const int2 output_shape,
                                    __private const int2 src_stride,
                                    __private const int2 dst_stride,
...
__kernel void nc4hw4_buffer_to_nc4hw4_buffer_floatout(GLOBAL_SIZE_2_DIMS
                                    __global const FLOAT *input_ptr,
                                    __private const int2 output_shape,
                                    __private const int2 src_stride,
                                    __private const int2 dst_stride,
...
__kernel void nc4hw4_buffer_to_nc4hw4_buffer_floatin_floatout(GLOBAL_SIZE_2_DIMS
                                    __global const float *input_ptr,
                                    __private const int2 output_shape,
                                    __private const int2 src_stride,
                                    __private const int2 dst_stride,
