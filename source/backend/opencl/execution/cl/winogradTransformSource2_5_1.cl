...
__kernel void winogradTransformSource(__read_only image2d_t uInput, // 0
    ...
    if (pos.x < unitWidth && pos.y < unitHeight) {
        ...
        batchIndex = batchOffset;
        {
            ...
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 0), +m00 - (FLOAT)1.25 * m20 + (FLOAT)0.25 * m40);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 1),
                 +(FLOAT)0.666667 * m10 + (FLOAT)0.666667 * m20 - (FLOAT)0.166667 * m30 - (FLOAT)0.166667 * m40);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 2),
                 -(FLOAT)0.666667 * m10 + (FLOAT)0.666667 * m20 + (FLOAT)0.166667 * m30 - (FLOAT)0.166667 * m40);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 3),
                 -(FLOAT)0.0833333 * m10 - (FLOAT)0.0416667 * m20 + (FLOAT)0.0833333 * m30 + (FLOAT)0.0416667 * m40);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 4),
                 +(FLOAT)0.0833333 * m10 - (FLOAT)0.0416667 * m20 - (FLOAT)0.0833333 * m30 + (FLOAT)0.0416667 * m40);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 5), +(FLOAT)4.0 * m10 - (FLOAT)5.0 * m30 + m50);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 6), +m01 - (FLOAT)1.25 * m21 + (FLOAT)0.25 * m41);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 7),
                 +(FLOAT)0.666667 * m11 + (FLOAT)0.666667 * m21 - (FLOAT)0.166667 * m31 - (FLOAT)0.166667 * m41);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 8),
                 -(FLOAT)0.666667 * m11 + (FLOAT)0.666667 * m21 + (FLOAT)0.166667 * m31 - (FLOAT)0.166667 * m41);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 9),
                 -(FLOAT)0.0833333 * m11 - (FLOAT)0.0416667 * m21 + (FLOAT)0.0833333 * m31 + (FLOAT)0.0416667 * m41);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 10),
                 +(FLOAT)0.0833333 * m11 - (FLOAT)0.0416667 * m21 - (FLOAT)0.0833333 * m31 + (FLOAT)0.0416667 * m41);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 11), +(FLOAT)4.0 * m11 - (FLOAT)5.0 * m31 + m51);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 12), +m02 - (FLOAT)1.25 * m22 + (FLOAT)0.25 * m42);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 13),
                 +(FLOAT)0.666667 * m12 + (FLOAT)0.666667 * m22 - (FLOAT)0.166667 * m32 - (FLOAT)0.166667 * m42);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 14),
                 -(FLOAT)0.666667 * m12 + (FLOAT)0.666667 * m22 + (FLOAT)0.166667 * m32 - (FLOAT)0.166667 * m42);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 15),
                 -(FLOAT)0.0833333 * m12 - (FLOAT)0.0416667 * m22 + (FLOAT)0.0833333 * m32 + (FLOAT)0.0416667 * m42);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 16),
                 +(FLOAT)0.0833333 * m12 - (FLOAT)0.0416667 * m22 - (FLOAT)0.0833333 * m32 + (FLOAT)0.0416667 * m42);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 17), +(FLOAT)4.0 * m12 - (FLOAT)5.0 * m32 + m52);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 18), +m03 - (FLOAT)1.25 * m23 + (FLOAT)0.25 * m43);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 19),
                 +(FLOAT)0.666667 * m13 + (FLOAT)0.666667 * m23 - (FLOAT)0.166667 * m33 - (FLOAT)0.166667 * m43);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 20),
                 -(FLOAT)0.666667 * m13 + (FLOAT)0.666667 * m23 + (FLOAT)0.166667 * m33 - (FLOAT)0.166667 * m43);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 21),
                 -(FLOAT)0.0833333 * m13 - (FLOAT)0.0416667 * m23 + (FLOAT)0.0833333 * m33 + (FLOAT)0.0416667 * m43);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 22),
                 +(FLOAT)0.0833333 * m13 - (FLOAT)0.0416667 * m23 - (FLOAT)0.0833333 * m33 + (FLOAT)0.0416667 * m43);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 23), +(FLOAT)4.0 * m13 - (FLOAT)5.0 * m33 + m53);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 24), +m04 - (FLOAT)1.25 * m24 + (FLOAT)0.25 * m44);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 25),
                 +(FLOAT)0.666667 * m14 + (FLOAT)0.666667 * m24 - (FLOAT)0.166667 * m34 - (FLOAT)0.166667 * m44);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 26),
                 -(FLOAT)0.666667 * m14 + (FLOAT)0.666667 * m24 + (FLOAT)0.166667 * m34 - (FLOAT)0.166667 * m44);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 27),
                 -(FLOAT)0.0833333 * m14 - (FLOAT)0.0416667 * m24 + (FLOAT)0.0833333 * m34 + (FLOAT)0.0416667 * m44);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 28),
                 +(FLOAT)0.0833333 * m14 - (FLOAT)0.0416667 * m24 - (FLOAT)0.0833333 * m34 + (FLOAT)0.0416667 * m44);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 29), +(FLOAT)4.0 * m14 - (FLOAT)5.0 * m34 + m54);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 30), +m05 - (FLOAT)1.25 * m25 + (FLOAT)0.25 * m45);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 31),
                 +(FLOAT)0.666667 * m15 + (FLOAT)0.666667 * m25 - (FLOAT)0.166667 * m35 - (FLOAT)0.166667 * m45);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 32),
                 -(FLOAT)0.666667 * m15 + (FLOAT)0.666667 * m25 + (FLOAT)0.166667 * m35 - (FLOAT)0.166667 * m45);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 33),
                 -(FLOAT)0.0833333 * m15 - (FLOAT)0.0416667 * m25 + (FLOAT)0.0833333 * m35 + (FLOAT)0.0416667 * m45);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 34),
                 +(FLOAT)0.0833333 * m15 - (FLOAT)0.0416667 * m25 - (FLOAT)0.0833333 * m35 + (FLOAT)0.0416667 * m45);
            WI_F(uOutput, (int2)(dstX, dstY + dstHeight * 35), +(FLOAT)4.0 * m15 - (FLOAT)5.0 * m35 + m55);
        }
    }
}
