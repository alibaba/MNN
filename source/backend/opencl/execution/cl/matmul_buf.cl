...
__kernel void matmul_transB_buf(GLOBAL_SIZE_2_DIMS __global const FLOAT* input_a,
    ...
    for (short pos = 0; pos < channel_blocks - 1; pos += 1) {
        ...
        b0 = vload4(inpb_offset, input_b);
        b1 = ((remainb >= 3) ? v_zero : vload4(inpb_offset + channel_blocks, input_b));
        b2 = ((remainb >= 2) ? v_zero : vload4(inpb_offset + channel_blocks*2, input_b));
        b3 = ((remainb >= 1) ? v_zero : vload4(inpb_offset + channel_blocks*3, input_b));
...
__kernel void matmul_transA_buf(GLOBAL_SIZE_2_DIMS __global const FLOAT* input_a,
    ...
    
    {
        ...
        FLOAT4 b0 = vload4(inpb_offset, input_b);
        FLOAT4 b1 = ((remain >= 3) ? v_zero : vload4(inpb_offset + width_blocks, input_b));
        FLOAT4 b2 = ((remain >= 3) ? v_zero : vload4(inpb_offset + width_blocks*2, input_b));
        FLOAT4 b3 = ((remain >= 3) ? v_zero : vload4(inpb_offset + width_blocks*3, input_b));
...
__kernel void matmul_transA_transB_buf(GLOBAL_SIZE_2_DIMS __global const FLOAT* input_a,
    ...
    for (short pos = 0; pos < channel_blocks - 1; pos += 1) {
        ...
        FLOAT4 b0 = vload4(inpb_offset, input_b);
        FLOAT4 b1 = ((remainb >= 3) ? v_zero : vload4(inpb_offset + channel_blocks, input_b));
        FLOAT4 b2 = ((remainb >= 2) ? v_zero : vload4(inpb_offset + channel_blocks*2, input_b));
        FLOAT4 b3 = ((remainb >= 1) ? v_zero : vload4(inpb_offset + channel_blocks*3, input_b));
    ...
    
    {
        const int inpa_offset = (4*(channel_blocks-1)) * height_blocks + height_blocks_idx;
        FLOAT4 a0 = vload4(inpa_offset, input_a);
        FLOAT4 a1 = ((remaina >= 3) ? v_zero : vload4(inpa_offset + height_blocks, input_a));
        FLOAT4 a2 = ((remaina >= 2) ? v_zero : vload4(inpa_offset + height_blocks*2, input_a));
        FLOAT4 a3 = ((remaina >= 1) ? v_zero : vload4(inpa_offset + height_blocks*3, input_a));
