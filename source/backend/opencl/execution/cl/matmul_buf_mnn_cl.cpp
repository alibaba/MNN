...
const char* matmul_buf =
    ...
    " #elif M_LEAVE_NUM == 1\n"
    " {\n"
    " A[0]=(COMPUTE_FLOAT4)((COMPUTE_FLOAT)input_a_offset[kindex*M],(COMPUTE_FLOAT)input_a_offset[(kindex+1)*M],("
    "COMPUTE_FLOAT)input_a_offset[(kindex+2)*M],(COMPUTE_FLOAT)input_a_offset[(kindex+3)*M]);\n"
    ...
    " COMPUTE_FLOAT4 tmp2=idn+2 >= N ? (COMPUTE_FLOAT4)0 : "
    "CONVERT_COMPUTE_FLOAT4(vload4(0,input_b_offset+kindex+2*K));\n"
    " \n"
