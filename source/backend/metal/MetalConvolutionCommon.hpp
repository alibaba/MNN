...
protected:
    ...
    virtual std::shared_ptr<MNN::Tensor> weightTransform(int group, int oc, int ic, int kh, int kw, const float *src, bool int8Weight = false, bool int4Weight = false, id<MTLBuffer> srcGpuBuffer = nil, int subBits = 0);
private:
