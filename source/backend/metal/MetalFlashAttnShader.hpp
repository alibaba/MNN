...
#define KV_TILE 32
#define NSG 4
#define NQ_PER_SG (Q_TILE / NSG)
#define NO_PER_SG ((HEAD_DIM / 8) / NSG)
...
#define FANAX_BQ 64
#define FANAX_BK 32
#define FANAX_TK (FANAX_BK / 16)
#define FANAX_TD (HEAD_DIM / 16)
...
const int q_valid_rows = seq_q - q_row_base;
