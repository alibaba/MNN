...
" uint gid [[thread_position_in_grid]]) {\n"
" auto V=in[int(gid)];\n"
" out[int(gid)]=fmax(V,0)+fmin(V,0)*M(slope);\n"
"}\n"
...
"}\n"
"kernel void conv_local(const device M4 *in [[buffer(0)]],\n"
" device M4 *out [[buffer(1)]],\n"
" constant conv_constants& cst [[buffer(2)]],\n"
" const device M4x4 *wt [[buffer(3)]],\n"
" const device M4 *biasTerms [[buffer(4)]],\n"
" threadgroup M4x4 *cols [[threadgroup(0)]],\n"
" uint3 gid [[thread_position_in_grid]],\n"
...
" /* true */ off_out[0]=activate((M4)(result[0]+b4),cst.activation);\n"
" if (valids[0]) off_out[1]=activate((M4)(result[1]+b4),cst.activation);\n"
" if (valids[1]) off_out[2]=activate((M4)(result[2]+b4),cst.activation);\n"
" if (valids[2]) off_out[3]=activate((M4)(result[3]+b4),cst.activation);\n"
"}\n"
;
