...
## News 🔥
- [2025/04/30] android app support qwen3 and dark mode [MnnLlmChat](./project/android/apps/MnnLlmApp/README.md#version-040).
<p align="center">
  <img width="20%" alt="Icon"  src="./apps/Android/MnnLlmChat/assets/qwen_3.gif" style="margin: 0 10px;">
</p>
