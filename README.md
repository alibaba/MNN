...
## News 🔥
- [2025/02/11] support for deepseek r1 1.5b[MNN-LLM-Android Version0.2.1](./project/android/apps/MnnLlmApp/README.md#version-021). including text-to-text, image-to-text, audio-to-text, and text-to-image generation.
