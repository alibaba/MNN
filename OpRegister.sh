...
echo "// This file is generated by Shell for ops regist\nnamespace MNN {" > $CPUFILE
echo "Start Regist CPU"
...
cat extern >> $CPUFILE
rm extern
echo '\nvoid registCPUOps() {' >> $CPUFILE
cat call >> $CPUFILE
echo '}\n}' >> $CPUFILE
rm call

# handle Shape
echo "Start Regist Shape"
