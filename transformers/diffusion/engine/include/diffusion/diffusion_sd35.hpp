...
public:
    ...
    static DiffusionSD35* createDiffusionSD35(std::string modelPath, DiffusionModelType modelType,
                                              MNNForwardType backendType, int memoryMode);

    bool run(const std::string prompt, const std::string imagePath, int iterNum, int randomSeed,
