...
int main(int argc, char* argv[]) {
    ...
    _insertScale(netT.get(), _scales, _tensorDescribes, featureBit, weightBit, blockSize);
    std::set<int> tensorDescribesHasScaleIndex;
    for(auto &iter : netT.get()->extraTensorDescribe){
        tensorDescribesHasScaleIndex.insert(iter->index);
    }
