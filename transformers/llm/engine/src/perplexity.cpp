...
void PPLMeasurer::init(Llm* llm, StateCacheManager* manager, std::vector<std::vector<int>> prompts, int max_len, int stride) {
    ...
    mStride = stride;
    mPrompts = prompts;
    mCandidate = mStateCacheManager->onCreateReference();
}

PPLMeasurer::PPLMeasurer(Llm* llm, StateCacheManager* manager, std::vector<std::vector<int>> prompts, int max_len, int stride) {
    init(llm, manager, prompts, max_len, stride);
}

PPLMeasurer::PPLMeasurer(Llm* llm, StateCacheManager* manager, std::vector<std::string> prompts, int max_len, int stride) {
