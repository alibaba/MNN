...
#   so vision & audio multi-modal LLM capabilities are available.
$CMAKE_ARGS = "-DMNN_SEP_BUILD=OFF -DMNN_BUILD_TRAIN=ON -DMNN_OPENCL=ON -DMNN_VULKAN=ON -DMNN_AVX512=ON -DMNN_BUILD_LLM=ON -DMNN_BUILD_LLM_OMNI=ON -DLLM_SUPPORT_VISION=ON -DLLM_SUPPORT_AUDIO=ON"
