...
TEST(Cat, Test1DTensors) {
  ...
  MNN::Express::VARP ans = Cat(allocator, {&a, &b}, 0);
...
TEST(Cat, Test2DTensorsDim1) {
  ...
  MNN::Express::VARP ans = Cat(allocator, {&a, &b}, 1);
...
TEST(Cat, Test3DTensorsDim2) {
  ...
  MNN::Express::VARP ans = Cat(allocator, {&a, &b}, 2);
