...
final class PresetZipformerASRService: @unchecked Sendable {
    ...
    private func recognizeOnWorker(audioURL: URL, expectedAudioSHA256: String) throws -> PresetASRRecognition {
        ...
        NSLog(
            "[PRESET_ASR] event=recognized runtime=sherpa-mnn model=x-asr-zipformer2 " +
                "precision=mnn-weight-int8-block64 backend=metal backup=cpu " +
    ...
    private func resolveAndValidateModelDirectory() throws -> URL {
        ...
        let manifest: [(String, String)] = [
            ("encoder-160ms.mnn", "61f74f69ed8e163edcfbc777f8dd3017b9d12b9b86bbe84b5e55f8c3d2db50b0"),
            ("decoder-160ms.mnn", "554673c8543d37420d7004511d84bdf794f3c4157e344102abff314362dcc10f"),
            ("joiner-160ms.mnn", "995e087ee1a4e79c95b01b5f8813cbc8f50646956ebb57d6e00455a513dd873d"),
