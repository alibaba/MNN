...
/// Enables dependency injection and provides a common contract for different download implementations
...
public protocol ModelDownloadManagerProtocol: Actor, Sendable {
    ...
    /// Should preserve temporary files to support resume functionality
    func cancelDownload() async
}

/// Type-erased wrapper for ModelDownloadManagerProtocol
/// Provides concrete type that can be stored as a property while maintaining protocol flexibility
@available(iOS 13.4, macOS 10.15, *)
...
/// Enables different creation strategies while maintaining type safety
@available(iOS 13.4, macOS 10.15, *)
...
public struct DefaultModelDownloadManagerFactory: ModelDownloadManagerFactory {
    ...
    public func createDownloadManager(
        ...
        return OptimizedModelScopeDownloadManager(
            repoPath: repoPath,
            config: config,
...
/// Provided for backward compatibility and testing purposes
@available(iOS 13.4, macOS 10.15, *)
