...
public protocol ModelDownloadManagerProtocol: Actor, Sendable {
     ...
     * 
     * @param destinationFolder Base folder where the model will be downloaded
     * @param modelId Unique identifier for the model in the repository
     * @param modelName Display name of the model (used for folder creation)
     * @param progress Optional closure called with download progress (0.0 to 1.0)
...
public actor AnyModelDownloadManager: ModelDownloadManagerProtocol {
     ...
     * 
     * @param manager The concrete download manager to wrap
     */
...
public protocol ModelDownloadManagerFactory {
     ...
     * @param source The model source (ModelScope or Modeler)
     * @return A download manager conforming to ModelDownloadManagerProtocol
     */
...
public struct DefaultModelDownloadManagerFactory: ModelDownloadManagerFactory {
     ...
     * @param sessionConfig URLSession configuration
     * @param enableLogging Whether to enable debug logging
     * @param concurrencyConfig Dynamic concurrency configuration
     */
    public init(
