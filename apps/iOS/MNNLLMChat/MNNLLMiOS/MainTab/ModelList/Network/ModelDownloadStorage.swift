...
final class ModelDownloadStorage {
     ...
     * 
     * @param userDefaults UserDefaults instance for persistence (defaults to .standard)
     */
     ...
     * 
     * @param file ModelFile object containing expected metadata
     * @param path Destination path where the file should be located
     * @return true if file exists and matches expected metadata, false otherwise
     */
     ...
     * 
     * @param file ModelFile object containing file metadata
     * @param path Destination path where the file was downloaded
     */
     ...
     * 
     * @return Dictionary mapping relative file paths to FileStatus objects,
     ...
     * 
     * @param path Full path to the file whose status should be cleared
     */
     ...
     * 
     * @param fullPath Absolute file path to convert
     * @return Relative path from Documents directory, or original path if conversion fails
     */
