...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_attr_5fvalue_2eproto = {
  false, false, 837, descriptor_table_protodef_attr_5fvalue_2eproto, "attr_value.proto", 
...
void AttrValue::set_allocated_list(::tensorflow::AttrValue_ListValue* list) {
  ...
  if (list) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::AttrValue_ListValue>::GetOwningArena(list);
    if (message_arena != submessage_arena) {
...
void AttrValue::set_allocated_func(::tensorflow::NameAttrList* func) {
  ...
  if (func) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::NameAttrList>::GetOwningArena(func);
    if (message_arena != submessage_arena) {
