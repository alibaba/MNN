...
function bench_android() {
    ...
    #benchmark OpenCL
    adb shell "LD_LIBRARY_PATH=$ANDROID_DIR $ANDROID_DIR/benchmark.out $ANDROID_DIR/benchmark_models $RUN_LOOP 8 3 2>$ANDROID_DIR/benchmark.err >> $ANDROID_DIR/benchmark.txt"
